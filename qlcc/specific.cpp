    ...
    , ui(new Ui::Specific)
{
    ...
    QProcess process;
    //process.start("\"D:\\Test\\qlcc\\api\\api.exe\"");
    //process.setProgram("\"D:\\Python\\python.exe\"");
    //process.setArguments({"\"D:\\Test\\qlcc\\api\\api.py\""});
    process.execute("D:\\Python\\PyCharm\\PyCharm Community Edition 2023.3.2\\bin\\pycharm64.exe",{"D:\\Test\\qlcc\\api\\api.py"});
    process.waitForStarted(1800000);
